...
export function UserProfileHeader({ user }: UserProfileHeaderProps) {
  return (
    <div className="relative group">
      ...
      {/* Profile Info Card */}
      <div className="px-6 -mt-12 relative pb-6 border-b border-slate-100 md:border-b-0">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 overflow-hidden">
          <div className="flex flex-col md:flex-row md:items-end gap-6 items-center md:items-end text-center md:text-left">
            ...
            <div className="mb-2 space-y-2">
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-y-2 gap-x-4 text-sm text-slate-500 font-medium pb-2 md:pb-0">
                ...
                {user.whatsapp && (
                  <div className="flex items-center gap-1.5 md:border-l border-slate-200 md:pl-4 whitespace-nowrap">
          ...
          <div className="flex items-center justify-center md:justify-end gap-2 mb-2 w-full md:w-auto overflow-x-auto pb-4 md:pb-0">
             <div className="bg-slate-50 p-2 px-4 rounded-xl border border-slate-100 flex flex-col items-center shrink-0">
             ...
             <Button variant="outline" size="icon" className="h-12 w-12 shrink-0 rounded-xl border-slate-200 hover:bg-slate-50 text-slate-500">
               <MessageSquare className="h-5 w-5" />
             </Button>
             <Button className="h-12 px-6 shrink-0 rounded-xl bg-primary hover:bg-primary/90 shadow-lg shadow-primary/20 transition-all active:scale-95">
               Manage Access
             </Button>
          </div>
        </div>
