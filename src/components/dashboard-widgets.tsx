...
export function QuickActions() {
  const actions = [
    { label: "New Notice", icon: Zap, color: "text-amber-500", bg: "bg-amber-50" },
    { label: "Verify User", icon: UserPlus, icon2: Plus, color: "text-blue-500", bg: "bg-blue-50" },
    { label: "Check Alerts", icon: AlertTriangle, color: "text-rose-500", bg: "bg-rose-50" },
    { label: "Refresh", icon: RefreshCw, color: "text-emerald-500", bg: "bg-emerald-50" }
  ]
